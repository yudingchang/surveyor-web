...
export default {
  ...
  methods: {
    ...
    handleAddNofit(){
      ...
      let NofitCloneE    
      NofitCloneE = ((this.cloneE.real_fatal_defect>this.cloneE.sampling.params.fatal_defect) || (this.cloneE.real_serious_defect>this.cloneE.sampling.params.serious_defect) || (this.cloneE.real_minor_defect>this.cloneE.sampling.params.minor_defect)) ? this.cloneE.products.map((item) =>{
        return item.remark_content
      }) :''
      // console.log
      let NofitCloneF
