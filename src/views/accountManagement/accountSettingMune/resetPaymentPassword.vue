        ...
        <el-row>
            ...
            <el-col :span="24" class="ResetLoginPassword-index">
                <div class="ResetLoginPassword">
                    <div>
                        <p><i class="iconfont icon-zhifumimazhongzhi1"></i></p>
                        <p>通过支付密码重置</p>
    ...
    .ResetLoginPassword-index{
        ...
        .ResetLoginPassword{
            >div{
                ...
                width:300px;
                height:400px;
                border:2px solid rgba(127,143,164,1);
                padding-top:87px;
                text-align: center;
                margin-right:120px;
                cursor:pointer;
                ...
                p:nth-child(3){
                    ...
                    border:1px solid rgba(127,143,164,1);
                    border-radius:4px;
                    line-height: 40px;
                    text-align: center;
                    margin:0 auto;
