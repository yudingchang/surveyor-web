  ...
  <div class="resetByPassword">
    <el-form ref="form" :model="data">
      ...
      <div class="password" v-if="active==2">         
          <el-form-item prop="new_password" :rules="[{ required: true, message: '请输入交易密码', trigger: 'blur' }]">
            <i class="iconfont icon-denglumimazhongzhi"></i>
            <el-input
          ...
          <el-form-item prop="repeat_new_password" :rules="[{ required: true, message: '请确认交易密码', trigger: 'blur' }]">
            <i class="iconfont icon-denglumimazhongzhi"></i>
            <el-input
