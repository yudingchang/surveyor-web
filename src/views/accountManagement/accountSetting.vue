        ...
        <div class="right">
          <div class="right-content">
            ...
            <div class="right-fixed">
              <el-input v-model="fitter.first_name" style="width:159px;" type="text" placeholder="请输入姓"/>
              <span style="margin-left:25px;">名：</span>
              <el-input v-model="fitter.last_name" style="width:159px;" type="text" placeholder="请输入名"/>
            </div>
          </div>
          <div class="right-content">
          ...
          <div class="right-content">
            ...
            <div class="right-fixed">
              <el-input v-model="fitter.department" style="width:380px;" type="text" placeholder="请输入部门"/>
            </div>
          </div>
          <div class="right-content">
            <div class="left-fixed">职位</div>
            <div class="right-fixed">
              <el-input v-model="fitter.position" style="width:380px;" type="text" placeholder="请输入职位"/>
            </div>
          </div>
          <div class="right-content">
            ...
            <div class="right-fixed">
              ...
              <el-input v-model="fitter.telephone" class="special-input" style="width:200px;margin-left:-10px;border-top-left-radius: 0;border-bottom-left-radius: 0;" type="text" placeholder="请输入固定电话"/>
            </div>
          </div>
          <div class="right-content">
            <div class="left-fixed">Skype</div>
            <div class="right-fixed">
              <el-input v-model="fitter.skype" style="width:380px;" type="text" placeholder="请输入Skype"/>
            </div>
          </div>
          <div class="right-content">
            <div class="left-fixed">QQ</div>
            <div class="right-fixed">
              <el-input v-model="fitter.qq" style="width:380px;" type="text" placeholder="请输入QQ"/>
            </div>
          </div>
          <div class="right-content">
            <div class="left-fixed">微信</div>
            <div class="right-fixed">
              <el-input v-model="fitter.wechat" style="width:380px;" type="text" placeholder="请输入微信"/>
            </div>
          </div>
        </div>
        <!-- </el-form> -->
      </div>
      <div :disabled="((fitter.first_name == ''))" class="save" @click="save()">保存</div>
    </div>
    <div v-if="normalStatu">
      <div class="content">
        <div class="left">
          <span class="gender">
            <span :class="{male:male,female:female,neuter:neuter}"/>
          </span>
        </div>
        <div class="right">
          <div class="right-content">
